                   ...
                   $emptyrec_email = "Please Fill up the recovery email!";
                    ...
                    for($i = 0; $i< count($data_filter)-1; $i++) {
                        ...
                        if( $json_decode['username'] == $username ) 
                        {
                            ...
                            $details = array('name' =>  $name, 'gender' => $gender, 'dob' =>$dob, 'religion' => $religion , 'fname' => $fname, 'mname' => $mname,
                               'presentadress' => $presentadress, 'permanentaddress' => $permanentaddress, 'email' =>  $email, 'phone' => $phone, 'website' => $website, 'sscyear' => $sscyear, 'sscinstitution'=> $sscinstitution, 'hscyear' => $hscyear, 'hscinstitution' => $hscinstitution,  'username' => $username, 'password' => $password, 'rec_email' => $rec_email);
